...
return [
    ...
    */
    ...
    'logo' => '<b>Escala</b> Corporation',
    'logo_img' => 'assets/img/logoescala.png',
        ...
        'Amcharts' => [
            ...
            'files' => [
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'assets/js/amcharts/core.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'assets/js/amcharts/charts.js',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'assets/js/amcharts/maps.js',
                ],
            ],
        ],
        'Sweetalert2' => [
