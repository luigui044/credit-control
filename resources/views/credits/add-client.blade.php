                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control campo-requerido" id="dui" name="dui"
                                        placeholder="Ingrese DUI" required>
                                    @error('dui')
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" max="99" min="18" class="form-control campo-requerido"
                                        id="age" name="age" placeholder="Edad" required>
                                </div>
                                @error('age')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control campo-requerido" id="ocupacion"
                                        name="ocupacion" placeholder="Ocupación" required>
                                    @error('ocupacion')
...
@section('js')
    ...
    <script src="{{ asset('assets/js/credits/addclient.js') }}"></script>
@stop
